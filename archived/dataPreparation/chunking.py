...
def text_chunking(text:str, chunk_size:int = 2500, chunk_overlap = 200, seperators:List[str] = []) -> List[str]:
    """
...
if __name__== '__main__':
    filepath = os.path.abspath('markdowns/Establishing flood thresholds for sea level rise impact communication.md')
